...
public class AACarousel: UIView,UIScrollViewDelegate {
    ...
    fileprivate func initWithLayerView() {
        ...
        layerView = UIView()
        layerView.backgroundColor = UIColor.black.withAlphaComponent(0.7)
        layerView.alpha = 1.0
    ...
    fileprivate func initWithLabel() {
        ...
        describedLabel.font = UIFont.systemFont(ofSize: 14)
    ...
    fileprivate func setLayerViewFrame() {
        ...
        layerView.frame = CGRect.init(x: 0 , y: scrollView.frame.size.height - 65, width: scrollView.frame.size.width * 5, height: 65)
    ...
    fileprivate func setLabelFrame() {
        ...
        describedLabel.frame = CGRect.init(x: scrollView.frame.size.width * 2 + 10 , y: layerView.frame.size.height - 80, width: scrollView.frame.size.width - 20, height: 70)
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let scrollDirect = direction.init(rawValue: Int(currentPage)) //direction.init(rawValue: Int(currentPage))
        
        switch scrollDirect ?? .none {
        case .none:
            break
        default:
